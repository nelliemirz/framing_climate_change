...
@DatasetReader.register("json_reader")
class JsonReader(TextClassificationJsonReader):
    """
    Reads tokens and their labels from a dataset.
    ...
    Registered as a `DatasetReader` with name "json_reader".
    ...
    def text_to_instance(
        self, text: str, labels: Union[str, int] = None
        ...
        if labels is not None:
            fields["labels"] = LabelField(
                labels, skip_indexing=self._skip_label_indexing)
